...
import com.example.shoppingapp.databinding.ActivityVerifyOtpBinding;
...
public class verifyOtp extends AppCompatActivity {
    ...
    Button getotpbutton,resendotpButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getotpbutton = findViewById(R.id.numberotpbtn2);
        resendotpButton = findViewById(R.id.resendotp);
        progressBar = findViewById(R.id.progressbar_verify_otp);
        progressBar1= findViewById(R.id.progressbar_verify_otp1);
        String number=getIntent().getStringExtra("number");
        binding.otp3text3.setText("Verify  +91" +number);
        checkinputs();
        ...
        binding.inputopt6.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
...
//                                            yeh code isliy taki us activity me return na a pay
    ...
    private void checkinputs() {
        if(!binding.inputopt1.getText().toString().isEmpty() && !binding.inputopt2.getText().toString().isEmpty() && !binding.inputopt3.getText().toString().isEmpty()
                && !binding.inputopt4.getText().toString().isEmpty()&& !binding.inputopt5.getText().toString().isEmpty()&& !binding.inputopt6.getText().toString().isEmpty())
        {
            binding.numberotpbtn2.setEnabled(true);
            binding.numberotpbtn2.setTextColor(Color.rgb(255,255,255));
        }
        else
        {
            binding.numberotpbtn2.setEnabled(false);
            binding.numberotpbtn2.setTextColor(Color.rgb(208,205,205));
