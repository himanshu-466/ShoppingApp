...
public class confirmfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_confirmfragment, container, false);
        RecyclerView recyclerView = view.findViewById(R.id.confirmRecyclerview);
        final ImageView image_empty = view.findViewById(R.id.confirmempty);
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if(snapshot.exists())
                                {
                                    for(DataSnapshot snapshot2:snapshot.getChildren()) {
                                        if (snapshot2.child("orderstatus").getValue().equals("confirm")) {
